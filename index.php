...
70%;"> </center>
   ...
   <header class="section-header">
        ...
        <p>Pay your Electricity bill by following a few quick steps</p>
    </header>
...
<div class="container">
    ...
    <input type="number" placeholder="Enter Mobile Number" name="mob" autocomplete="off" required>


 <label for="psw-repeat"><b> Complaint *</b></label>
    <input type="text" placeholder="Enter your complaint" name="complaint"  autocomplete="off" required>
